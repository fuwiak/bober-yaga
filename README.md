...
**bober-yaga** (Яга) — модульный CLI для сервисов Яндекса (Go + Charm Bubble Tea).
...
Установленная команда: `yaga` (бинарь / симлинк после `install.sh`).
...
Яндекс® и названия сервисов (Вебмастер, Метрика, Директ и др.) — товарные знаки соответствующих правообладателей. **bober-yaga** — независимый неофициальный клиент для удобной работы с публичными API и кабинетами, без гарантий совместимости и без официальной поддержки со стороны Яндекса.
