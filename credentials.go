...
func allCredSpecs() []CredSpec {
	return []CredSpec{
		...
		{
			Key:   "YANDEX_BUSINESS_OAUTH_TOKEN",
			Title: "Business Partner API token",
			Brick: "business",
			UIURL: "https://oauth.yandex.ru/",
			How:   "yaga business oauth · fallback: YANDEX_OAUTH_TOKEN. API: geoadv-api.yandex.ru",
		},
		{
			Key:   "YANDEX_BUSINESS_REFRESH_TOKEN",
			Title: "Business refresh token",
			Brick: "business",
			UIURL: "https://oauth.yandex.ru/",
			How:   "Пишется после yaga business oauth exchange",
			Optional: true,
		},
		{
			Key:   "YANDEX_BUSINESS_CLIENT_LOGIN",
			Title: "Business Client-Login (субклиент)",
			Brick: "business",
			UIURL: "https://yandex.ru/sprav/companies",
			How:   "Логин владельца карточки / субклиента агентства. Нужен для campaigns/is-owner",
			Optional: true,
		},
		{
			Key:   "YANDEX_BUSINESS_COMPANY_ID",
			Title: "Business companyId",
			Brick: "business",
			UIURL: "https://yandex.ru/sprav/companies",
			How:   "ID организации из URL sprav/… . Default 113092981562",
			Optional: true,
		},
		{
